...
export const ZVecIOBackendType = cjs.ZVecIOBackendType;
export const ZVecCollectionSchema = cjs.ZVecCollectionSchema;
export const ZVecInitialize = cjs.ZVecInitialize;
export const ZVecSetDefaultJiebaDictDir = cjs.ZVecSetDefaultJiebaDictDir;
export const ZVecGetDefaultJiebaDictDir = cjs.ZVecGetDefaultJiebaDictDir;
export const ZVecGetIOBackendType = cjs.ZVecGetIOBackendType;
export const ZVecGetIOBackendDescription = cjs.ZVecGetIOBackendDescription;
